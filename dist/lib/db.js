...
exports.dbResetAllData = exports.dbEnvSmembers = exports.dbEnvSadd = exports.dbEnvHmset = exports.dbEnvHmget = exports.dbEnvHset = exports.dbEnvHget = exports.dbEnvDel = exports.dbEnvTtl = exports.dbEnvSetex = exports.dbEnvExpire = exports.dbEnvSet = exports.dbEnvMget = exports.dbEnvGet = exports.dbFindEx = exports.dbBulk = exports.dbUpdate = exports.dbRequest = void 0;
...
const storage = require("../db.original.json");
...
function dbRequest(collectionName, method, argsArray, cb) {
    try {
...
function dbUpdate(collectionName, query, update, params, cb) {
    try {
...
function dbBulk(collectionName, bulk, cb) {
    try {
        const collection = getOrAddCollection(collectionName);
        let result;
        bulk.forEach(i => {
...
exports.dbBulk = dbBulk;
function dbFindEx(collectionName, query, opts, cb) {
    try {
        recursReplaceNeNull(query);
        const collection = getOrAddCollection(collectionName);
...
exports.dbFindEx = dbFindEx;
function dbEnvGet(name, cb) {
    try {
...
exports.dbEnvGet = dbEnvGet;
function dbEnvMget(names, cb) {
    try {
        const item = db.getCollection('env').get(1) || { data: {} };
...
exports.dbEnvMget = dbEnvMget;
function dbEnvSet(name, value, cb) {
    try {
        const env = db.getCollection('env');
        let values = env.get(1);
        if (values) {
...
exports.dbEnvSet = dbEnvSet;
function dbEnvExpire(name, seconds, cb) {
    try {
        const env = db.getCollection('env');
...
exports.dbEnvExpire = dbEnvExpire;
function dbEnvSetex(name, seconds, value, cb) {
    try {
...
exports.dbEnvSetex = dbEnvSetex;
function dbEnvTtl(name, cb) {
    try {
        const env = db.getCollection('env');
        const expiration = env.get(2);
...
exports.dbEnvTtl = dbEnvTtl;
function dbEnvDel(name, cb) {
    try {
        const env = db.getCollection('env');
        const values = env.get(1);
...
exports.dbEnvDel = dbEnvDel;
function dbEnvHget(name, field, cb) {
    try {
        const env = db.getCollection('env');
        const values = env.get(1);
...
exports.dbEnvHget = dbEnvHget;
function dbEnvHset(name, field, value, cb) {
    try {
        const env = db.getCollection('env');
        let values = env.get(1);
        if (values) {
...
exports.dbEnvHset = dbEnvHset;
function dbEnvHmget(name, fields, cb) {
    try {
        const env = db.getCollection('env');
...
exports.dbEnvHmget = dbEnvHmget;
function dbEnvHmset(name, data, cb) {
    try {
        const env = db.getCollection('env');
        let values = env.get(1);
        if (values) {
...
exports.dbEnvHmset = dbEnvHmset;
function dbEnvSadd(name, data, cb) {
    try {
        if (!_.isArray(data)) {
            data = [data];
        }
...
exports.dbEnvSadd = dbEnvSadd;
function dbEnvSmembers(name, cb) {
    try {
        const env = db.getCollection('env');
        const values = env.get(1) || { data: {} };
        if (values && values.data && values.data[name]) {
...
exports.dbEnvSmembers = dbEnvSmembers;
function dbResetAllData(cb) {
    try {
...
exports.dbResetAllData = dbResetAllData;
